...
namespace rpg.console
{
    class ConsoleController
    {
        ...
        public void EnableTestrun(string projectname, string testnamePattern, bool value)
        {
        ...
        /// <summary>
        /// Spool testrun names to console (core ready)
        /// </summary>
        /// <param name="projectName"></param>
        ...
        public void ListTestrunNamesToConsole(string projectName, string testrunPattern = ".*")
        {
            ...
            string[] enabledtestnames = da.GetTestrunNames(projectName, testrunPattern);
            string[] disabledtestnames = da.GetDisabledTestrunNames(projectName, testrunPattern);
